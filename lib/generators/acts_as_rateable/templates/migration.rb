class ActsAsRateableMigration < ActiveRecord::Migration
  def self.up
    ...
    create_table :ratings do |t|
      t.column :professional_id, :integer
      t.column :rate_id, :integer
      t.column :rateable_id, :integer
      t.column :rateable_type, :string, :limit => 32
      t.column :rate_on_id, :integer
      t.column :rate_on_type, :string, :limit => 32
    ...
    add_index :ratings, [:rateable_id, :rateable_type, :rate_on_id, :rate_on_type]
  end
